    ...
    <div className="bg-[#fdf9f3] py-10 px-6 mt-8 md:mt-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 items-center">
        ...
        <div className="md:col-span-1">
          ...
          <button className="mt-6 bg-yellow-600 text-white px-6 py-3  shadow hover:bg-yellow-700 transition flex items-center">
            Explore More
          </button>
        </div>

        {/* Slider */}
        <div className="md:col-span-2 relative pb-16">
              ...
              >
                <div
                  className={`relative overflow-hidden  ${
                    index === activeIndex ? "h-[600px]" : "h-[500px]"
                  }`}
                >
                  <Image
                    src={slide.image}
                ...
                {index === activeIndex && (
                  <div className="absolute bottom-8 left-10 flex">
                    <div className="bg-white z-10 opacity-80 px-14 py-8">
                      <p className="text-gray-500 text-sm">{slide.subtitle}</p>
                      <h3 className="text-xl font-semibold text-gray-800">
                        {slide.title}
                      </h3>
                    </div>
                    <button className="mt-20 bg-yellow-600 text-white p-4 hover:bg-yellow-700 transition">
